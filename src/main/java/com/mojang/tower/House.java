...
public class House extends Entity {
    ...
    public void tick() {
        ...
        if (buildTime < buildDuration) {
            ...
            if (type == HouseType.BARRACKS && island.warriorPopulation < island.warriorPopulationCap
                && island.resources.wood >= WOOD_PER_WARRIOR) {
                peon = getRandomPeon(80, 80, true);
                if (peon != null && peon.job == null && peon.type == 0) {
            ...
            if (type == HouseType.RESIDENCE && island.population < island.populationCap
                && island.resources.food >= FOOD_PER_PEON && random.nextInt(20) == 0) {
