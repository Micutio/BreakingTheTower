...
public class HouseType {
    ...
    public static final HouseType WOODCUTTER =
        new HouseType(2, "Woodcutter", 10, 15, 0, 0).setAcceptsResource(Resources.WOOD);
    ...
    public static final HouseType WINDMILL =
        new HouseType(7, "Miller", 8, 15, 15, 0).setAcceptsResource(Resources.FOOD);
